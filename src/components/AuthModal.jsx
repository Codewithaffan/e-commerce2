        ...
        {view === "login" && (
          ...
          >
            ...
            <div className="flex items-center justify-between text-sm">
              <button type="button" onClick={openRegister} className="text-blue-600 hover:underline">
                Create an account
              </button>
              <button type="button" onClick={openForgot} className="text-blue-600 hover:underline">
                Forgot password?
              </button>
            </div>
        ...
        {view === "register" && (
          ...
          >
            ...
            <div className="text-center text-sm">
              <button type="button" onClick={openLogin} className="text-blue-600 hover:underline">
