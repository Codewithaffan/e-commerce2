  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          Return <span className="bg-gradient-to-r from-red-500 to-yellow-500 bg-clip-text text-transparent">Policy</span>
        </motion.h1>
        ...
        <div className="bg-red-100 border-l-4 border-red-600 text-red-700 p-6 rounded-lg shadow mb-10">
          ...
          <p>
            ...
            <u>used, worn, or washed</u>, returns and exchanges will not 
        ...
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4">Return Policy Explained</h2>
          <p>
            Customers are advised to carefully inspect their product at the 
            time of delivery. This includes checking the size, fabric, print 
            quality, and packaging. If any defect, mismatch, or visible damage 
            is noticed, it must be reported immediately to the delivery 
            partner. Our team will initiate a replacement only if the issue is 
            raised on the spot. Once the product has been accepted and the 
            delivery agent has left, we cannot process returns.
          </p>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4">Why This Policy Exists</h2>
          <p>
            Unlike many mass-produced clothing brands, Refilley emphasizes 
            authenticity, personalization, and limited-edition designs. 
            Allowing post-use returns would undermine our efforts to maintain 
            exclusivity and premium quality. Furthermore, clothing is a 
            personal-use item. Once worn or washed, its resale or reuse is not 
            possible. This strict stance guarantees that every item delivered 
            is 100% new and untouched.
          </p>

          <h2 className="text-2xl font-bold mt-10 mb-4">Examples of Valid Return Cases</h2>
          <ul>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4">Examples of Invalid Return Cases</h2>
          <ul>
